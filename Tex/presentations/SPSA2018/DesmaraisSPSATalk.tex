...
\begin{frame} \frametitle{Two Limitations to Case-Level Analysis}
\Large
\begin{enumerate}
...
\begin{frame} \frametitle{ The Citation TERGM: $C_t|C_{<t}$ via $h(C_{\leq t})$}
\centering
...
\includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/mutual_coef_trend.pdf} & \includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/triangle_coef_trend.pdf} \\
 
     Activity & Popularity \\
\includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/o2star_coef_trend.pdf} & \includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/i2star_coef_trend.pdf} \\
...
\includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/mq_coef_trend.pdf} & \includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/absdiffmq_coef_trend.pdf} \\
 
   Same Issue &  Majority Size \\
\includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/sameissue_coef_trend.pdf} & \includegraphics[width = 0.55\textwidth, trim= .5cm 1cm 0.5cm .45cm,clip=true]{../../images/numberjusticespro_coef_trend.pdf} \\
...
\item Randomly split dyads 80/20 into training and test
\item Estimate models using training, predict test

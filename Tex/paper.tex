...
When it comes to the development and testing of theory, the defining feature of networks is that the fundamental element under study---the relationship between two units (i.e., the citation from one opinion to another) is a piece of a complex web of relations that cannot be fully understood without considering how the singular relationship fits into that complex web.

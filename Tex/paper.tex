...
be the set of all possible adjacency matrices among $N_t$ cases. $N_t$ denotes the the number of cases in the network at time $t$. Note that the cardinality of $\mathcal{C}_t$ increases exponentially for every newly added case. The probability of observing $C_t$ given past citations $C_{<t}$, where $C_{\leq t}$ is the network up to time $t$ is defined as
\begin{equation}
...
\includegraphics[width = 0.475\textwidth, trim= 0.1cm 1cm 0.5cm .45cm,clip=true]{images/sameissue_coef_trend_linear.pdf} & \includegraphics[width = 0.475\textwidth, trim= 0.1cm 1cm 0.5cm .45cm,clip=true]{images/numberjusticespro_coef_trend_linear.pdf} \\
 ...
 (e) Overruled Cases & (f) Difference in Years \\
\includegraphics[width = 0.475\textwidth, trim= 0.1cm 1cm 0.5cm .45cm,clip=true]{images/overruled_coef_trend_linear.pdf} & \includegraphics[width = 0.475\textwidth, trim= 0.1cm 1cm 0.5cm .45cm,clip=true]{images/yeardiff_coef_trend_linear.pdf} \\
 
   (g) Reciprocity & (h) Transitivity \\
...
\hline \hline
 & mean & range & mean & range \\ 
  \hline
precision & 0.642 & (0.6311, 0.6527) & 0.8664 & (0.8645, 0.8681) \\ 
  recall & 0.0866 & (0.0835, 0.0882) & 0.5947 & (0.591, 0.5978) \\ 
  F1 score & 0.1526 & (0.1475, 0.1552) & 0.7053 & (0.7026, 0.7079) \\ 
   \hline \hline
\end{tabular}
\caption{The predictive performance of the directed dyadic models with cubic trends, over ten 80/20 train/test splits.}
\label{tab:prediction_cubic}
\begin{tabular}{rllll}
\hline \hline
 & mean & range & mean & range \\ 
  \hline
precision & 0.645 & (0.635, 0.6668) & 0.8681 & (0.8639, 0.8712) \\ 
  recall & 0.0864 & (0.083, 0.0887) & 0.5955 & (0.5899, 0.6004) \\ 
  F1 score & 0.1524 & (0.1468, 0.1562) & 0.7064 & (0.7018, 0.7094) \\ 
   \hline \hline
\end{tabular}
\caption{The predictive performance of the directed dyadic models with quartic trends, over ten 80/20 train/test splits.}
\label{tab:prediction_quartic}
\end{table}

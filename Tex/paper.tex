...
{\color{blue} This section needs to be completely revised. Model is not a TERGM anymore. - CS} 
...
Adding one single edge to the network changes the indegree distribution of the network so that a case with an indegree of $s$ turns into a case with an indegree of $s + 1$. With our notation this means that $D_r$ and $D_{r+1}$ get replaced by
